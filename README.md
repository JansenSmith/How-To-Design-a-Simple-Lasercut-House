...
![Size of internal rooms in red. Size of roof in green.](image/sizing_annotated.png){width=120%}


![Wood thickness in red (remember to change to 6mm if you are using thicker wood). Add a QR code to the SVG in green.](image/misc_settings_annotated.png){width=150%}
...
![This preview image shows you what your SVG will look like. Note the Zoom feature. The QR code links to the design you have made. The 100mm rectangle at the bottom can help you size on the laser cutter.](image/preview.png){width=150%}
